 ...
 * PAR�METROS ADMITIDOS : 'es' || 'cat'
 * */
function setIdioma($idioma){

    $esCorrecto = false;

    //Comprobamos que el par�metro que se ha pasado es correcto
    ...
    if ($esCorrecto) {
        ...
        echo "El par�metro de entrada: " . $idioma . " no es correcto, debe ser 'es' o 'cat'";
    }
...
<!-- <h1>Formateo de fechas con Carbon, pr�cticas y ejemplos:</h1> -->
<div>
